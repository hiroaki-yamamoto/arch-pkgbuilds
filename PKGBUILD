...
# ================= Important Note =================
# This PKGBUILD is NOT official package. Use this
# package on your own responsibility, or don't use.
# ==================================================
...
sha256sums=('401d7c8fef594999a460d10c72c5a94e9c2e1022f16795ec51746b0d165418b2'
            'SKIP'
            'ad6a82eec92934588830b33c1d6f55c2c2344c4898b539fb238978fc9038190f'
            'SKIP'
            ...
            '1ed7fff6003bc98ce9e923b97b7b36c6d7e1ae2edd58a1cb4835cec18b1c1601'
...
_package() {
  ...
  install -D -m644 "${srcdir}/linux-lts44.preset" "${pkgdir}/etc/mkinitcpio.d/${pkgbase}.preset"
  sed \
    -e "1s|'linux.*'|'${pkgbase}'|" \
